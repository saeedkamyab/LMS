...
{
    public class CreateEmployeeRequestHandler : IRequestHandler<CreateEmployeeRequest, BaseCommandResponse>
    {
        IUnitOfWork _unitOfWork;
        IMapper _mapper;
        EmployeeValidator _validator;
        public CreateEmployeeRequestHandler(IUnitOfWork unitOfWork, IMapper mapper, EmployeeValidator validator)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
            _validator = validator;
        }
        public async Task<BaseCommandResponse> Handle(CreateEmployeeRequest request, CancellationToken cancellationToken)
        {
