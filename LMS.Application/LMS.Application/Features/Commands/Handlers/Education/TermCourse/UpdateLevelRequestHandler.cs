...
using LMS.Application.Features.Commands.Requests.Education.TermCourse;
...
{
    public class UpdateTermCourseRequestHandler : IRequestHandler<UpdateTermCourseRequest, BaseCommandResponse>
    {
        IUnitOfWork _unitOfWork;
        IMapper _mapper;
        TermCourseValidator _validator;
        public UpdateTermCourseRequestHandler(IUnitOfWork unitOfWork, IMapper mapper, TermCourseValidator validator)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
            _validator = validator;
        }
        public async Task<BaseCommandResponse> Handle(UpdateTermCourseRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _unitOfWork.TermCourseRepository.UpdateAsync(TermCourse);
                return new BaseCommandResponse
                {
