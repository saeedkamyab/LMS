...
namespace LMS.Application.Features.Commands.Requests_Handlers.Identity.Student
{
    public class UpdateStudentRequestHandler : IRequestHandler<UpdateStudentRequest, BaseCommandResponse>
    {
        IUnitOfWork _unitOfWork;
        IMapper _mapper;
        StudentValidator _validator;
        public UpdateStudentRequestHandler(IUnitOfWork unitOfWork, IMapper mapper, StudentValidator validator)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
            _validator = validator;
        }
        public async Task<BaseCommandResponse> Handle(UpdateStudentRequest request, CancellationToken cancellationToken)
        {
